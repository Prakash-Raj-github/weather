        ...
        fetchData(url.airPollution(lat, lon), function(airPollution){
            ...
            card.innerHTML = `
                ...
                <div class="highlight-list">
                    ...
                    <div class="card card-sm highlight-card">
                    <h1 class="title-3">Visibility</h1>
                    ...
                    <div class="card card-sm highlight-card">
                    <h1 class="title-3">Feels Like</h1>
            ...
            for( const [index, data] of forecastList.entries()) {
                ...
                tempLi.innerHTML = `
                    ...
                    <div class="card card-sm slider-card">
                        ...
                        <img src="./assets/images/weather_icons/${icon}.png"
                        width="48" height="48" loading="lazy" alt="${description}" class="weather-icon" 
                        title="${description}">
                ...
                li.innerHTML = `
                    <div class="icon-wrapper">
                        <img src="./assets/images/weather_icons/${icon}.png" width="36"
                         height="36" alt="${description}" class="weather-icon"
                         title="${description}">
